...
exports.checkoutArchive = function (DatArchive, archive, version) {
  if (archive._archive && archive._loadPromise) {
    // probably node-dat-archive, use this cheat method to solve the performance issue
    let clone = Object.assign(Object.create(Object.getPrototypeOf(archive)), archive)
    // clone.prototype = archive.prototype
    clone._archive = clone._archive.checkout(version)
    return clone
  }

  // use default behavior
  return new DatArchive(archive.url + '+' + version)
}
